...
# If you use MacOs, you might need to install some little things otherwise is installed by default, like wget, with brew. If there is any trouble, just download pdb files mannually.
